...
/***/ "./src/app/events/add/add.component.css":
/***/ (function(module, exports) {

module.exports = "div#card-event {\r\n    margin-top: 45px;\r\n}\r\n\r\nul.dropdown-menu.dropdown-menu-left {\r\n    cursor: pointer;\r\n}\r\n\r\n#langDropdown {\r\n    margin-top: -10px;\r\n    position: absolute;\r\n    width: 100%;\r\n}\r\n\r\ni.fcancel.material-icons {\r\n    cursor: pointer;\r\n}\r\n\r\n.form-full-width {\r\n    width: 100%;\r\n}\r\n\r\n.form-half-width {\r\n    width: 25%;\r\n}"

/***/ }),

/***/ "./src/app/events/add/add.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"main-content\">\r\n    <div class=\"container-fluid\">\r\n        <div class=\"row\">\r\n            <form [formGroup]=\"eventForm\" novalidate (ngSubmit)=\"onSubmit()\" #f=\"ngForm\">\r\n                <div class=\"col-md-offset-1 col-md-10\">\r\n                    <div class=\"dropdown\" *ngIf=\"eventForm.get('items').controls.length == 0\">\r\n                        <button class=\"dropdown-toggle btn btn-rose btn-block\" data-toggle=\"dropdown\">Dodaj jezik<b class=\"caret\"></b></button>\r\n                        <ul class=\"dropdown-menu dropdown-menu-left\">\r\n                            <li class=\"dropdown-header\">izaberi jezik</li>\r\n                            <li *ngFor=\"let lang of langs\">\r\n                                <a (click)=\"addItem(lang)\">{{ lang.name }}</a>\r\n                            </li>\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n                <div formArrayName=\"items\" *ngFor=\"let item of eventForm.get('items').controls; let i = index;\">\r\n                    <div [formGroupName]=\"i\">\r\n                        <div class=\"col-md-offset-1 col-md-10\">\r\n                            <div class=\"card\">\r\n                                <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                                    <i class=\"material-icons\">language</i>\r\n                                </div>\r\n                                <div class=\"pull-right remove-btn\">\r\n                                    <h4 class=\"card-title\"><i (click)=\"onRemoveLangs(item.controls.language_name.value , item.controls.language.value ,  i)\" class=\"fcancel material-icons\">cancel</i></h4>\r\n                                </div>\r\n                                <div class=\"card-content\">\r\n                                    <h4 class=\"card-title\">{{item.controls['language_name'].value}}</h4>\r\n                                    <div class=\"col-md-offset-1 col-md-10\">\r\n                                        <div class=\"row\">\r\n                                            <mat-form-field class=\"form-full-width\">\r\n                                                <mat-label>Naziv dešavanja</mat-label>\r\n                                                <input type=\"text\" matInput placeholder=\"Naziv\" formControlName=\"name\">\r\n                                                <mat-error>\r\n                                                    <span *ngIf=\"item.controls['name'].touched && item.controls['name'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                </mat-error>\r\n                                            </mat-form-field>\r\n                                        </div>\r\n                                        <div class=\"row \">\r\n                                            <mat-form-field class=\"form-full-width\">\r\n                                                <mat-label>Opis dešavanja</mat-label>\r\n                                                <textarea matInput type=\"text\" placeholder=\"Opis...\" formControlName=\"description\"></textarea>\r\n                                                <mat-error>\r\n                                                    <span *ngIf=\"item.controls['description'].touched && item.controls['description'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                </mat-error>\r\n                                            </mat-form-field>\r\n                                            <mat-radio-group>\r\n                                                <mat-radio-button (click)=\"isDisabled(true, i)\" [value]=true>Link</mat-radio-button>\r\n                                                <mat-radio-button (click)=\"isDisabled(false ,i)\" [value]=false>Opis</mat-radio-button>\r\n                                            </mat-radio-group>\r\n                                        </div>\r\n                                        <div id=\"langDropdown\" class=\"dropdown\" *ngIf=\"eventForm.get('items').controls.length == i+1 && langs.length !== 0\">\r\n                                            <button class=\"dropdown-toggle btn btn-rose btn-block\" data-toggle=\"dropdown\">Dodaj jezik<b class=\"caret\"></b></button>\r\n                                            <ul class=\"dropdown-menu dropdown-menu-left\">\r\n                                                <li class=\"dropdown-header\">izaberi jezik</li>\r\n                                                <li *ngFor=\"let lang of langs\">\r\n                                                    <a (click)=\"addItem(lang)\">{{ lang.name }}</a>\r\n                                                </li>\r\n                                            </ul>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-offset-1 col-md-10\">\r\n                    <div id=\"card-event\" class=\"card\">\r\n                        <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                            <i class=\"material-icons\">assignment</i>\r\n                        </div>\r\n                        <div class=\"card-content\">\r\n                            <h4 class=\"card-title\">Forma za dodavanje vinskih dešavanja</h4>\r\n                            <div class=\"row\">\r\n                                <div class=\"col-md-12\">\r\n                                    <div class=\"col-md-4 col-sm-6\">\r\n                                        <legend>Slika za naslovnu</legend>\r\n                                        <div class=\"fileinput fileinput-new text-center\" data-provides=\"fileinput\">\r\n                                            <div class=\"fileinput-new thumbnail\">\r\n                                                <img src=\"./assets/img/image_placeholder.jpg\" alt=\"...\">\r\n                                            </div>\r\n                                            <div class=\"fileinput-preview fileinput-exists thumbnail\"></div>\r\n                                            <div>\r\n                                                <span class=\"btn btn-rose btn-block btn-file\">\r\n                                          <span class=\"fileinput-new\">Izaberi sliku</span>\r\n                                                <span class=\"fileinput-exists\">Promeni</span>\r\n                                                <input (change)=\"onUploadCover($event)\" type=\"file\" name=\"cover_image\" />\r\n                                                </span>\r\n                                                <a href=\"#\" #coverPath class=\"btn btn-danger btn-round fileinput-exists\" data-dismiss=\"fileinput\"><i class=\"fa fa-times\"></i>Ukloni</a>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-md-offset-1 col-md-7\">\r\n                                        <div class=\"col-md-12\">\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Datum početka</mat-label>\r\n                                                    <input matInput [matDatepicker]=\"dp\" placeholder=\"Unesi datum početka\" formControlName=\"start\" (dateInput)=\"addEvent('input', $event)\" (dateChange)=\"addEvent('change', $event)\">\r\n                                                    <mat-datepicker-toggle matSuffix [for]=\"dp\"></mat-datepicker-toggle>\r\n                                                    <mat-datepicker #dp></mat-datepicker>\r\n                                                </mat-form-field>\r\n                                                <mat-form-field class=\"form-half-width\">\r\n                                                    <mat-label>Vreme početka</mat-label>\r\n                                                    <input matInput type=\"text\" placeholder=\"Vreme\" class=\"timepicker\">\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Datum završetka</mat-label>\r\n                                                    <input matInput [min]=\"minDate\" [matDatepicker]=\"dp2\" placeholder=\"unesi datum završetka\" formControlName=\"end\">\r\n                                                    <mat-datepicker-toggle matSuffix [for]=\"dp2\"></mat-datepicker-toggle>\r\n                                                    <mat-datepicker #dp2></mat-datepicker>\r\n                                                </mat-form-field>\r\n                                                <mat-form-field class=\"form-half-width\">\r\n                                                    <mat-label>Vreme završetka</mat-label>\r\n                                                    <input matInput type=\"text\" placeholder=\"Vreme\" class=\"timepicker\">\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Link</mat-label>\r\n                                                    <input matInput type=\"text\" placeholder=\"http://www... ili https://www...\" formControlName=\"link\">\r\n                                                    <mat-error>\r\n                                                        <span *ngIf=\"eventForm.controls['link'].touched && eventForm.controls['link'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                    </mat-error>\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"row\">\r\n                                <div class=\"text-center\">\r\n                                    <button type=\"submit\" class=\"btn btn-rose btn-fill btn-wd\" [disabled]=\"!eventForm.valid\">DODAJ DEŠAVANJE</button>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"row\">\r\n                        <div class=\"col-md-12\">\r\n                            <div class=\"card\">\r\n                                <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                                    <i class=\"material-icons\">location_on</i>\r\n                                </div>\r\n                                <div class=\"card-content\">\r\n                                    <h4 class=\"card-title\">Mesto dešavanja</h4>\r\n                                    <mat-form-field class=\"form-full-width\">\r\n                                        <mat-label>Adresa</mat-label>\r\n                                        <input matInput type=\"text\" placeholder=\"Adresa\" formControlName=\"location\" #address>\r\n                                        <mat-error>\r\n                                            <span *ngIf=\"eventForm.controls['location'].touched && eventForm.controls['location'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                        </mat-error>\r\n                                    </mat-form-field>\r\n                                    <agm-map (mapClick)=\"onChoseLocation($event)\" [latitude]=\"lat\" [longitude]=\"lng\">\r\n                                        <agm-marker [latitude]=\"lat\" [longitude]=\"lng\"></agm-marker>\r\n                                    </agm-map>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>x"

/***/ }),

/***/ "./src/app/events/add/add.component.ts":
...
var AddComponent = /** @class */ (function () {
    function AddComponent(fb, http, mapsAPILoader, ngZone, alert) {
        this.fb = fb;
        this.http = http;
        this.mapsAPILoader = mapsAPILoader;
        this.ngZone = ngZone;
        this.alert = alert;
        this.languages = []; // storage formated name and description/link for send to backend
        this.defaultLanguage = 1; // default language Srpski = 1
        this.langs = []; // storage of all languages
    }
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.eventForm = this.fb.group({
            start: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            end: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            location: ["", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            lat: [""],
            lng: [""],
            link: [{ value: "", disabled: true }, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            items: this.fb.array([]),
            languages: [""]
        });
    ...
    AddComponent.prototype.addEvent = function (title, event) {
        var selectedDate = event.target.value;
        selectedDate = __WEBPACK_IMPORTED_MODULE_6_moment__(selectedDate).format('YYYY-MM-DD');
        this.minDate = selectedDate;
    };
    AddComponent.prototype.isDisabled = function (value, index) {
        var _this = this;
        var select = this.eventForm.get("items");
        var formGroup = select.controls[index];
        if (value == true) {
        ...
        select.controls.forEach(function (element) {
            var item = element;
            if (item.controls.description.disabled === true) {
                _this.eventForm.controls.link.enable();
            }
        });
    };
    ...
    AddComponent.prototype.createLanguage = function (languageId, languageName) {
        return this.fb.group({
            ...
            description: [{ value: "", disabled: false }, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            language: [languageId],
    ...
    AddComponent.prototype.addItem = function (value) {
        ...
        this.items = this.eventForm.get("items");
    ...
    AddComponent.prototype.onRemoveLangs = function (languageName, languageId, index) {
        var _this = this;
        var selected = this.eventForm.get("items");
        swal({
    ...
    AddComponent.prototype.onSubmit = function () {
        ...
        console.log(time);
        var formatStart = this.eventForm.controls.start.value;
        var formatEnd = this.eventForm.controls.end.value;
        formatStart = __WEBPACK_IMPORTED_MODULE_6_moment__(formatStart).format("YYYY-MM-DD"); // formatiranje datuma
        formatEnd = __WEBPACK_IMPORTED_MODULE_6_moment__(formatEnd).format("YYYY-MM-DD"); // formatiranje datuma
        var startDate = formatStart + " " + time[0];
        var endDate = formatEnd + " " + time[1];
        var fd = new FormData();
        var langForm = this.eventForm.get("items");
        var languages = [];
        ...
        var formInput = this.eventForm.value;
        ...
        this.http.postFormData("create/happening", fd).subscribe(function (httpResponse) {
            if (httpResponse.status === 201) {
                var controls = _this.eventForm.get('items');
                ...
                _this.alert.showNotification('Uspesno ste dodali novi dogadjaj', 'success', 'notifications');
            }
        });
    };
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_5__angular_material__["g" /* MatDatepicker */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__angular_material__["g" /* MatDatepicker */])
    ...
    AddComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "app-add",
            template: __webpack_require__("./src/app/events/add/add.component.html"),
            styles: [__webpack_require__("./src/app/events/add/add.component.css")]
        }),
...
/***/ "./src/app/events/edit/edit.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/events/edit/edit.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"main-content\">\r\n    <div class=\"container-fluid\">\r\n        <div class=\"row\">\r\n            <form [formGroup]=\"eventForm\" novalidate (ngSubmit)=\"onSubmit()\">\r\n                <div class=\"col-md-offset-1 col-md-10\">\r\n                    <div class=\"dropdown\" *ngIf=\"eventForm.get('items').controls.length == 0\">\r\n                        <button class=\"dropdown-toggle btn btn-rose btn-block\" data-toggle=\"dropdown\">Dodaj jezik<b class=\"caret\"></b></button>\r\n                        <ul class=\"dropdown-menu dropdown-menu-left\">\r\n                            <li class=\"dropdown-header\">izaberi jezik</li>\r\n                            <li *ngFor=\"let lang of langs\">\r\n                                <a (click)=\"addItem(lang)\">{{ lang.name }}</a>\r\n                            </li>\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n                <div formArrayName=\"items\" *ngFor=\"let item of eventForm.get('items').controls; let i = index;\">\r\n                    <div [formGroupName]=\"i\">\r\n                        <div class=\"col-md-offset-1 col-md-10\">\r\n                            <div class=\"card\">\r\n                                <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                                    <i class=\"material-icons\">language</i>\r\n                                </div>\r\n                                <div class=\"pull-right remove-btn\">\r\n                                    <h4 class=\"card-title\"><i (click)=\"onRemoveLangs(item.controls.language_name.value , item.controls.name_id.value ,  i)\" class=\"fcancel material-icons\">cancel</i></h4>\r\n                                </div>\r\n                                <div class=\"card-content\">\r\n                                    <h4 class=\"card-title\">{{item.controls['language_name'].value}}</h4>\r\n                                    <div class=\"col-md-offset-1 col-md-10\">\r\n                                        <div class=\"row\">\r\n                                            <mat-form-field class=\"form-full-width\">\r\n                                                <mat-label>Naziv dešavanja</mat-label>\r\n                                                <input type=\"text\" matInput placeholder=\"Naziv\" formControlName=\"name\">\r\n                                                <mat-error>\r\n                                                    <span *ngIf=\"item.controls['name'].touched && item.controls['name'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                </mat-error>\r\n                                            </mat-form-field>\r\n                                        </div>\r\n                                        <div class=\"row \">\r\n                                            <mat-form-field class=\"form-full-width\">\r\n                                                <mat-label>Opis dešavanja</mat-label>\r\n                                                <textarea matInput type=\"text\" placeholder=\"Opis...\" formControlName=\"description\"></textarea>\r\n                                                <mat-error>\r\n                                                    <span *ngIf=\"item.controls['description'].touched && item.controls['description'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                </mat-error>\r\n                                            </mat-form-field>\r\n                                            <mat-radio-group>\r\n                                                <mat-radio-button (click)=\"isDisabled(true, i)\" [value]=true>Link</mat-radio-button>\r\n                                                <mat-radio-button (click)=\"isDisabled(false ,i)\" [value]=false>Opis</mat-radio-button>\r\n                                            </mat-radio-group>\r\n                                            <div class=\"row\">\r\n                                                <button type=\"button\" *ngIf=\"item.controls['flag'].value == 1\" (click)=\"onSaveLanguage(item)\" class=\"btn btn-rose btn-fill btn-wd pull-right\" [disabled]=\"!item.valid || saved\">SAČUVAJ JEZIK</button>\r\n                                            </div>\r\n                                            <div id=\"langDropdown\" class=\"dropdown\" *ngIf=\"eventForm.get('items').controls.length == i+1 && langs.length !== 0\">\r\n                                                <button class=\"dropdown-toggle btn btn-rose btn-block\" data-toggle=\"dropdown\">Dodaj jezik<b class=\"caret\"></b></button>\r\n                                                <ul class=\"dropdown-menu dropdown-menu-left\">\r\n                                                    <li class=\"dropdown-header\">izaberi jezik</li>\r\n                                                    <li *ngFor=\"let lang of langs\">\r\n                                                        <a (click)=\"addItem(lang)\">{{ lang.name }}</a>\r\n                                                    </li>\r\n                                                </ul>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-offset-1 col-md-10\">\r\n                    <div id=\"card-event\" class=\"card\">\r\n                        <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                            <i class=\"material-icons\">assignment</i>\r\n                        </div>\r\n                        <div class=\"card-content\">\r\n                            <h4 class=\"card-title\">Forma za uređivanje vinskih dešavanja</h4>\r\n                            <div class=\"row\">\r\n                                <div class=\"col-md-12\">\r\n                                    <div class=\"col-md-4 col-sm-6\">\r\n                                        <div class=\"pull-left\">\r\n                                            <legend>Slika za naslovnu</legend>\r\n                                        </div>\r\n                                        <div class=\"fileinput fileinput-new text-center\" data-provides=\"fileinput\">\r\n                                            <div class=\"fileinput-new thumbnail\">\r\n                                                <img *ngIf=\"coverImage !== null\" [src]=\"coverImage\" alt=\"...\">\r\n                                            </div>\r\n                                            <div class=\"fileinput-preview fileinput-exists thumbnail\"></div>\r\n                                            <div>\r\n                                                <span class=\"btn btn-rose btn-block btn-file\">\r\n                                          <span class=\"fileinput-new\">Izaberi sliku</span>\r\n                                                <span class=\"fileinput-exists\">Promeni</span>\r\n                                                <input (change)=\"onUploadCoverImage($event)\" type=\"file\" name=\"cover_image\" />\r\n                                                </span>\r\n                                                <a href=\"#\" class=\"btn btn-danger btn-round fileinput-exists\" data-dismiss=\"fileinput\"><i class=\"fa fa-times\"></i>Ukloni</a>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-md-offset-1 col-md-7\">\r\n                                        <div class=\"col-md-12\">\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Datum početka</mat-label>\r\n                                                    <input matInput [matDatepicker]=\"dp\" placeholder=\"unesi datum početka\" formControlName=\"start\" (dateInput)=\"addEvent('input', $event)\" (dateChange)=\"addEvent('change', $event)\">\r\n                                                    <mat-datepicker-toggle matSuffix [for]=\"dp\"></mat-datepicker-toggle>\r\n                                                    <mat-datepicker #dp></mat-datepicker>\r\n                                                </mat-form-field>\r\n                                                <mat-form-field class=\"form-half-width\">\r\n                                                    <input matInput type=\"text\" placeholder=\"Vreme početka\" class=\"timepicker start\">\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Datum završetka</mat-label>\r\n                                                    <input matInput [min]=\"minDate\" [matDatepicker]=\"dp2\" placeholder=\"unesi datum završetka\" formControlName=\"end\">\r\n                                                    <mat-datepicker-toggle matSuffix [for]=\"dp2\"></mat-datepicker-toggle>\r\n                                                    <mat-datepicker #dp2></mat-datepicker>\r\n                                                </mat-form-field>\r\n                                                <mat-form-field class=\"form-half-width\">\r\n                                                    <input matInput type=\"text\" placeholder=\"Vreme završetka\" class=\"timepicker end\">\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                            <div class=\"row\">\r\n                                                <mat-form-field>\r\n                                                    <mat-label>Link</mat-label>\r\n                                                    <input matInput type=\"text\" placeholder=\"http://www... ili https:://www...\" formControlName=\"link\">\r\n                                                    <mat-error>\r\n                                                        <span *ngIf=\"eventForm.controls['link'].touched && eventForm.controls['link'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                                    </mat-error>\r\n                                                </mat-form-field>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"row\">\r\n                                <div class=\"text-center\">\r\n                                    <button type=\"submit\" class=\"btn btn-rose btn-fill btn-wd\" [disabled]=\"!eventForm.valid\">SAČUVAJ\r\n                                        </button>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"row\">\r\n                        <div class=\"col-md-12\">\r\n                            <div class=\"card\">\r\n                                <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                                    <i class=\"material-icons\">location_on</i>\r\n                                </div>\r\n                                <div class=\"card-content\">\r\n                                    <h4 class=\"card-title\">Lokacija dešavanja</h4>\r\n                                    <mat-form-field class=\"form-full-width\">\r\n                                        <input matInput type=\"text\" placeholder=\"Adresa\" formControlName=\"location\" #address>\r\n                                        <mat-error>\r\n                                            <span *ngIf=\"eventForm.controls['location'].touched && eventForm.controls['location'].hasError('required')\">Ovo polje je <strong>obavezno!</strong></span>\r\n                                        </mat-error>\r\n                                    </mat-form-field>\r\n                                    <agm-map (mapClick)=\"onChoseLocation($event)\" [latitude]=\"lat\" [longitude]=\"lng\">\r\n                                        <agm-marker [latitude]=\"lat\" [longitude]=\"lng\"></agm-marker>\r\n                                    </agm-map>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>x"

/***/ }),

/***/ "./src/app/events/edit/edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditComponent = /** @class */ (function () {
    function EditComponent(fb, http, mapsAPILoader, ngZone, alert, route) {
        this.fb = fb;
        this.http = http;
        this.mapsAPILoader = mapsAPILoader;
        this.ngZone = ngZone;
    ...
    EditComponent.prototype.addItem = function (value) {
        var isSaved;
        var items = this.eventForm.get("items");
    ...
    EditComponent.prototype.removeItem = function () {
        var controls = this.eventForm.get('items');
        while (controls.length !== 0) {
            controls.removeAt(0);
        }
    };
    // creating formGroup when pick language from dropdown
    EditComponent.prototype.createLanguage = function (nameId, descId, eventName, eventDesc, langName, langId, isNew) {
        if (isNew === void 0) { isNew = true; }
        var fg = this.fb.group({
            name: [eventName, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            description: [{ value: eventDesc, disabled: false }, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            name_id: nameId,
            desc_id: descId,
    ...
    EditComponent.prototype.createItem = function (nameId, descId, eventName, eventDesc, langName, langId, isNew) {
        if (isNew === void 0) { isNew = true; }
        var items = this.eventForm.get("items");
    ...
    EditComponent.prototype.onSaveLanguage = function (value) {
        ...
        this.http
            ...
            if (httpResponse.status === 204) {
                var itemArray = _this.eventForm.controls['items'];
    ...
    EditComponent.prototype.onRemoveLangs = function (language_name, language_id, index) {
        ...
        swal({
            ...
            _this.http
                .delete("delete/language/happening/" + _this.id + "/" + language_id)
                .subscribe(function (httpResponse) {
                if (httpResponse.status === 204) {
                    swal({
                        title: "Obrisano!",
    ...
    EditComponent.prototype.initLoadingData = function (onSave) {
        ...
        this.subscriptionData = this.http.get('patch/initialize/happening/' + this.id, 1).subscribe(function (httpResponse) {
            if (httpResponse.status == 200) {
                var serverData = httpResponse.json();
                var formatStart = serverData.start;
                var formatEnd = serverData.end;
                var formatStartTime_1 = serverData.start;
                var formatEndTime_1 = serverData.end;
                formatStart = __WEBPACK_IMPORTED_MODULE_6_moment__(formatStart).format("YYYY-MM-DD"); // formatiranje datuma
                formatEnd = __WEBPACK_IMPORTED_MODULE_6_moment__(formatEnd).format("YYYY-MM-DD"); // formatiranje datuma
                formatStartTime_1 = __WEBPACK_IMPORTED_MODULE_6_moment__(formatStartTime_1).format("HH:mm"); // formatiranje vremena
                formatEndTime_1 = __WEBPACK_IMPORTED_MODULE_6_moment__(formatEndTime_1).format("HH:mm"); // formatiranje vremena
                _this.eventForm.controls.start.setValue(formatStart);
                _this.eventForm.controls.end.setValue(formatEnd);
                _this.eventForm.controls.location.setValue(serverData.location);
                _this.coverImage = serverData.image_path;
                _this.lat = serverData.lat;
                _this.lng = serverData.lng;
                console.log(formatStart, formatEnd);
                if (serverData.link != null) {
                    _this.eventForm.controls.link.enable();
                    _this.eventForm.controls.link.setValue(serverData.link);
                }
                $("input.timepicker.start").each(function (index, value) {
                    $($(value).data("date", formatStartTime_1)).val(formatStartTime_1);
                });
                $("input.timepicker.end").each(function (index, value) {
                    console.log(formatEndTime_1);
                    $($(value).data("date", formatEndTime_1)).val(formatEndTime_1);
                });
            ...
            _this.alert.showNotification('Greska na serveru podaci nisu ucitani! pokušajte kasnije', 'danger', '');
        });
    };
    // on uploading image 
    EditComponent.prototype.onUploadCoverImage = function (event) {
    ...
    EditComponent.prototype.isDisabled = function (value, index) {
        var _this = this;
        var select = this.eventForm.get("items");
        var formGroup = select.controls[index];
        if (value == true) {
    ...
    EditComponent.prototype.formattingDate = function (date) {
        var value = __WEBPACK_IMPORTED_MODULE_6_moment__(date).format("YYYY-MM-DD"); // formatiranje datuma
        return value;
    };
    EditComponent.prototype.addEvent = function (value, event) {
        var selectedDate = event.target.value;
        selectedDate = __WEBPACK_IMPORTED_MODULE_6_moment__(selectedDate).format('YYYY-MM-DD');
        this.minDate = selectedDate;
    };
    EditComponent.prototype.onSubmit = function () {
        ...
        var languages = [];
        var langForm = this.eventForm.get('items');
        var startDate = this.eventForm.controls.start.value;
        var endDate = this.eventForm.controls.end.value;
        ...
        var mergeStartDateTime = this.formattingDate(startDate) + ' ' + time[0];
        var mergeEndDateTime = this.formattingDate(endDate) + ' ' + time[1];
        ...
        fd.append("json", JSON.stringify(formInput));
        if (this.isFormValid) {
            this.http.postFormData("patch/happening/" + this.id, fd).subscribe(function (httpResponse) {
                if (httpResponse.status == 204) {
                    _this.removeItem();
                    _this.initLoadingData(true);
    ...
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-edit',
            template: __webpack_require__("./src/app/events/edit/edit.component.html"),
            styles: [__webpack_require__("./src/app/events/edit/edit.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_2__services_http_service__["a" /* HttpService */],
            __WEBPACK_IMPORTED_MODULE_3__agm_core__["b" /* MapsAPILoader */],
...
module.exports = ".mat-column-id {\r\n    -webkit-box-flex: 0;\r\n        -ms-flex: 0 0 50px;\r\n            flex: 0 0 50px;\r\n}\r\n\r\n.mat-column-actions {\r\n    display: -webkit-box;\r\n    display: -ms-flexbox;\r\n    display: flex;\r\n    -webkit-box-pack: end;\r\n        -ms-flex-pack: end;\r\n            justify-content: flex-end;\r\n    min-width: 160px;\r\n}\r\n\r\n.example-container {\r\n    display: -webkit-box;\r\n    display: -ms-flexbox;\r\n    display: flex;\r\n    -webkit-box-orient: vertical;\r\n    -webkit-box-direction: normal;\r\n        -ms-flex-direction: column;\r\n            flex-direction: column;\r\n    min-width: 300px;\r\n}\r\n\r\n.mat-table {\r\n    overflow: auto;\r\n    max-height: 500px;\r\n}\r\n\r\nmat-table.events-table.mat-elevation-z8.mat-table {\r\n    max-height: 800px;\r\n}\r\n\r\n.loading_spinner {\r\n    position: absolute;\r\n    margin-left: 50%;\r\n    margin-top: 70px;\r\n}\r\n\r\nmat-cell,\r\nmat-header-cell {\r\n    padding-left: 20px;\r\n}\r\n\r\nmat-cell.actions-cell.mat-cell.cdk-column-actions.mat-column-actions.ng-star-inserted {\r\n    min-width: 100px;\r\n}\r\n\r\n.my-mat-header-cell {\r\n    -webkit-box-flex: 0;\r\n        -ms-flex: 0 0 20%;\r\n            flex: 0 0 20%;\r\n}"
...
module.exports = "<div class=\"main-content\">\r\n    <div class=\"container-fluid\">\r\n        <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n                <div class=\"col-md-1 col-md-offset-11\">\r\n                    <button (click)=\"onAddEvent()\" class=\"btn btn-rose btn-lg\">DODAJ</button>\r\n                </div>\r\n                <div class=\"card\">\r\n                    <div class=\"card-header card-header-icon\" data-background-color=\"darkred\">\r\n                        <i class=\"material-icons\">assignment</i>\r\n                    </div>\r\n                    <div class=\"card-content\">\r\n                        <h4 class=\"card-title\">Dešavanja</h4>\r\n                        <div class=\"toolbar\">\r\n                            <!--        Here you can write extra buttons/actions for the toolbar              -->\r\n                            <mat-form-field class=\"form-full-width\">\r\n                                <mat-select [value]=\"selectedLanguage\" placeholder=\"language\">\r\n                                    <mat-option *ngFor=\"let language of languages\" [value]=\"language.id\" (click)=\"onChangeLanguage(language.id, language.name)\">{{language.name}}</mat-option>\r\n                                </mat-select>\r\n                            </mat-form-field>\r\n                        </div>\r\n                        <div class=\"material-datatables table-responsive\">\r\n                            <div class=\"loading_spinner\" *ngIf=\"dataSource.loading$ | async\">\r\n\r\n                                <mat-spinner [diameter]=\"40\"></mat-spinner>\r\n\r\n                            </div>\r\n                            <mat-table class=\"events-table mat-elevation-z8\" [dataSource]=\"dataSource\">\r\n\r\n                                <ng-container matColumnDef=\"id\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>ID</mat-header-cell>\r\n\r\n                                    <mat-cell *matCellDef=\"let element\">{{element.id}}</mat-cell>\r\n\r\n                                </ng-container>\r\n\r\n                                <ng-container matColumnDef=\"name\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Naziv</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"description-cell\" *matCellDef=\"let element\">{{element.name}}</mat-cell>\r\n\r\n                                </ng-container>\r\n\r\n                                <ng-container matColumnDef=\"start\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Datum početka</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"description-cell\" *matCellDef=\"let element\">{{element.start}}</mat-cell>\r\n\r\n                                </ng-container>\r\n\r\n                                <ng-container matColumnDef=\"end\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Datum završetka</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"description-cell\" *matCellDef=\"let element\">{{element.end}}</mat-cell>\r\n\r\n                                </ng-container>\r\n\r\n                                <ng-container matColumnDef=\"location\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Lokacija</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"description-cell\" *matCellDef=\"let element\">{{element.location}}</mat-cell>\r\n\r\n                                </ng-container>\r\n\r\n                                <ng-container matColumnDef=\"link\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Link</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"my-mat-header-cell description-cell\" *matCellDef=\"let element\"><a href=\"{{element.link}}\">{{element.link}}</a> </mat-cell>\r\n\r\n                                </ng-container>\r\n                                <ng-container matColumnDef=\"actions\">\r\n\r\n                                    <mat-header-cell *matHeaderCellDef>Akcije</mat-header-cell>\r\n\r\n                                    <mat-cell class=\"actions-cell\" *matCellDef=\"let element\">\r\n                                        <button (click)=\"onEditEvent(element.id)\" type=\"button\" rel=\"tooltip\" class=\"btn btn-just-icon btn-success\"><i class=\"material-icons\">edit</i></button>\r\n                                        <button (click)=\"onDeleteEvent(element.id, element.name)\" type=\"button\" rel=\"tooltip\" class=\"btn btn-just-icon btn-danger\"><i class=\"material-icons\">close</i></button>\r\n                                    </mat-cell>\r\n                                </ng-container>\r\n\r\n                                <mat-header-row *matHeaderRowDef=\"displayedColumns\"></mat-header-row>\r\n\r\n                                <mat-row *matRowDef=\"let row; columns: displayedColumns\"></mat-row>\r\n\r\n                            </mat-table>\r\n\r\n                            <mat-paginator [length]=\"total\" [pageSize]=\"pageSize\"></mat-paginator>\r\n                        </div>\r\n                    </div>\r\n                    <!-- end content-->\r\n                </div>\r\n                <!--  end card  -->\r\n            </div>\r\n            <!-- end col-md-12 -->\r\n        </div>\r\n        <!-- end row -->\r\n    </div>\r\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__notifications_notifications_service__ = __webpack_require__("./src/app/notifications/notifications.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_event_datasource__ = __webpack_require__("./src/app/services/event.datasource.ts");
...
var EventsComponent = /** @class */ (function () {
    function EventsComponent(router, http, alert) {
        this.router = router;
        this.http = http;
        this.alert = alert;
        this.defaultLanguage = 1;
        this.languages = [];
        this.displayedColumns = ['id', 'name', 'start', 'end', 'location', 'link', 'actions'];
    }
    EventsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_5__services_event_datasource__["a" /* EventsDataSource */](this.http);
        this.dataSource.loadEvents(1, this.defaultLanguage);
        this.selectedLanguage = this.defaultLanguage;
        // get all languages
        this.subscriptionLang = this.http.get('dropdown/language', this.defaultLanguage).subscribe(function (httpResponse) {
            _this.languages = httpResponse.json();
        });
        // get total and page size
        this.subscription = this.http.get('get/happening', this.selectedLanguage).subscribe(function (httpResponse) {
            if (httpResponse.status == 200) {
    ...
    EventsComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.paginator.page.pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["tap"])(function () { return _this.LoadEventPage(); })).subscribe();
    };
    EventsComponent.prototype.LoadEventPage = function () {
        this.dataSource.loadEvents(this.paginator.pageIndex + 1, this.selectedLanguage);
        console.log('loadWineryPage triggered!: ', this.paginator.pageIndex);
    };
    EventsComponent.prototype.onChangeLanguage = function (id, name) {
        var _this = this;
        console.log(id, name);
        this.selectedLanguage = id;
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_5__services_event_datasource__["a" /* EventsDataSource */](this.http);
        this.dataSource.loadEvents(this.paginator.pageIndex, this.selectedLanguage);
    ...
    EventsComponent.prototype.onAddEvent = function () {
        this.router.navigate(["events/add"]);
    };
    EventsComponent.prototype.onEditEvent = function (id) {
        this.router.navigate(["events/edit", id]);
    };
    EventsComponent.prototype.onDeleteEvent = function (id, name) {
        var _this = this;
        swal({
            ...
            _this.http.delete("delete/happening/" + id).subscribe(function (httpResponse) {
                if (httpResponse.status === 204) {
                    swal({
                        title: "Obrisano!",
                        text: "Doga\u0111aj " + name + " je uspesno obrisan!",
                        type: "success",
                        confirmButtonClass: "btn btn-success",
                        buttonsStyling: false
                    });
                    _this.http.get('get/happening', _this.selectedLanguage).subscribe(function (data) {
                        _this.paginator.length = data.json().total;
                    });
                    _this.dataSource = new __WEBPACK_IMPORTED_MODULE_5__services_event_datasource__["a" /* EventsDataSource */](_this.http);
                    _this.dataSource.loadEvents(_this.paginator.pageIndex, _this.selectedLanguage);
                    _this.paginator.firstPage();
                    _this.alert.showNotification("Uspesno ste obrisali " + name + " dogadjaj", "success", "notifications");
                }
                (function (error) {
                    _this.alert.showNotification("Greska!" + name + "nije obrisan", "danger", "error");
                });
            });
        }, function (dismiss) {
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__events_routing__ = __webpack_require__("./src/app/events/events.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__events_component__ = __webpack_require__("./src/app/events/events.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__add_add_component__ = __webpack_require__("./src/app/events/add/add.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__edit_edit_component__ = __webpack_require__("./src/app/events/edit/edit.component.ts");
    ...
    EventsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__events_routing__["a" /* EventsTable */]),
...
/***/ "./src/app/events/events.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EventsTable; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__events_component__ = __webpack_require__("./src/app/events/events.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__add_add_component__ = __webpack_require__("./src/app/events/add/add.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_edit_component__ = __webpack_require__("./src/app/events/edit/edit.component.ts");
...
var EventsTable = [
    {
        ...
        children: [{
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_0__events_component__["a" /* EventsComponent */]
            }]
    },
    {
        path: '',
...
/***/ "./src/app/services/event.datasource.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EventsDataSource; });
...
var EventsDataSource = /** @class */ (function () {
    function EventsDataSource(httpService) {
        this.httpService = httpService;
        this.eventsSubject = new __WEBPACK_IMPORTED_MODULE_0_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]([]);
        this.loadingSubject = new __WEBPACK_IMPORTED_MODULE_0_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](false);
        this.loading$ = this.loadingSubject.asObservable();
    }
    EventsDataSource.prototype.loadEvents = function (pageIndex, lang) {
        var _this = this;
        this.loadingSubject.next(true);
        this.httpService.findEvents('get/happening', lang, pageIndex).pipe(Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["catchError"])(function () { return Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of__["a" /* of */])([]); }), Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["finalize"])(function () { return _this.loadingSubject.next(false); }))
            .subscribe(function (events) { return _this.eventsSubject.next(events); });
    };
